...
const PageTwo = () => {
    return (
        <>
            <h5 className="font-gotham font-[500] text-[21px] leading-[39px] mt-[32.85px]">To finalise your entry please fill in your details below</h5>
            <div className='lg:w-[567px]'>
                <div className="flex content-between mt-[40.75px] text-customForestGreen">
                    <div className='flex flex-col w-[265px] mr-[40px]'>
                        ...
                        <Field type="text" name="firstName" className="border  outline-none w-full text-[13px] h-[36px] p-[6px]" />
                    ...
                    <div className='flex flex-col w-[265px]'>
                        ...
                        <Field type="text" name="lastName" className="border outline-none w-full text-[13px] h-[36px] p-[6px]" required/>
                ...
                <div className="flex content-between mt-[18px] text-customForestGreen">
                    <div className='flex flex-col w-[265px] mr-[40px]'>
                        ...
                        <Field type="text" name="state" className="border  outline-none w-full text-[13px] h-[36px] p-[6px]" />
