...
const PageOne = ({ setCurrentPage }) => {
    return (
        <>
            ...
            <div>
                <Field name='partyDescription' as="textarea" className='lg:w-[674px] w-full h-[240px] border-[0.5px] border-customGreen outline-none resize-none mt-[31px] text-[12px] p-[12px] font-medium' />
